...
import { addProcess } from "../stores/useFixedMemoryStore"

function AddProcessToFixedMemory() {
    ...
    const handleOnSubmit = (e:React.FormEvent<HTMLFormElement>) => {
        e.preventDefault()
        if (time && size) {
            addProcess({ size:parseInt(size), time:parseInt(time) })
            setSize("")
            setTime("")
        }
    }
...
export { AddProcessToFixedMemory }
